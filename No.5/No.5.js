...
let _0x4e96b4 = window, _0x30bc70 = String;
let _0x35bb1d = Date
//初始化变量
let _$Tk = CryptoJS;
let _$Ww;
...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    ...
    let b64pad = 1;
     ...
     let _0x1badc3, _0x38ca59, _0x431764, _0x43f1b4, _0x5722c0, _0x3e0c38 = _0x1171c8, _0xdb4d2c = _0x4dae05, _0x1724c5 = _0x183a1d, _0x257ec6 = _0xcfa373;
...
function get_params() {
    //明文
    _0x4e96b4['_$pr'] = [
        "c07a0df3df920fc459de67b4655f4062",
        "f3b78711ac49a6e84607007a5823c0f8",
        "f9758891c9b2f2e76ed0e2be18d79615",
        "162dd65d45f24bb1a82fab4fd587491a"
    ]
    ...
    let _0x29dd83 = _$Tk['AES']['encrypt'](_$Ww, _0x4e96b4['_$qF'], {
                                            'mode': _$Tk['mode']['ECB'],
                                            'padding': _$Tk['pad']['Pkcs7']
                                        });
    let RM4 = _0x29dd83['toString']();
    console.log()
    return {
        "cookies": {
            "m": pr_5,
